...
r1= Review.create(body: "Awesome book, a must read!! --Ella", reviewer: "Ella", book_id: 1 )
r2= Review.create(body: "Super interesting. Great book --Ella", reviewer: "Ella", book_id: 2 )
r3= Review.create(body: "A little dry --Ella", reviewer: "Ella", book_id: 3 )
r4= Review.create(body: "Awesome book --Ella", reviewer: "Ella", book_id: 4 )
r5= Review.create(body: "Read this so fast! --Nate", reviewer: "Nate", book_id: 1 )
r6= Review.create(body: "SO GOOD!! --Nate", reviewer: "Nate", book_id: 2 )
r7= Review.create(body: "You all read this before me! --mom", reviewer: "Emma", book_id: 2 )
r8= Review.create(body: "Many pages, much learns --mom", reviewer: "Emma", book_id: 4 )
r9= Review.create(body: "Super good! --mom", reviewer: "Emma", book_id: 5 )
r10= Review.create(body: "I really liked this! --mom", reviewer: "Emma", book_id: 6 )
r11= Review.create(body: "This book has changed my life. I used to look down upon people who required 8 hours of sleep or more a night --mom", reviewer: "Emma", book_id: 7 )
r12= Review.create(body: "Many pages, much learns --mom", reviewer: "Emma", book_id: 8 )
r13= Review.create(body: "Dr. Tyson put his all into this. Letters from an Astrophysicist isn’t just a book, it’s an encompassing of someone’s soul. Great read and price as always --Nate", reviewer: "Nate", book_id: 8 )
r14= Review.create(body: "Great read --mom", reviewer: "Nate", book_id: 7 )
r14= Review.create(body: "Just buy this - breakfast changed forever :) --Nate", reviewer: "Nate", book_id: 9 )
r15= Review.create(body: "Super helpful!! --mom", reviewer: "Emma", book_id: 10 )
r16= Review.create(body: "Not dry! Actually enjoyed it --mom", reviewer: "Emma", book_id: 3 )
r17= Review.create(body: "Glad I read this - feel like I know a lot more about our history! --Nate", reviewer: "Nate", book_id: 5 )
